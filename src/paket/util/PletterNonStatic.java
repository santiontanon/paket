 ...
 * @author santi
 */
public class PletterNonStatic {

    int d_bytes[];
    int maxlen[] = {128, 128 + 128, 512 + 128, 1024 + 128, 2048 + 128, 4096 + 128, 8192 + 128};
    int varcost[] = new int[65536];
    ...
    Pakdata p[][] = new Pakdata[7][];

    String sourcefilename = null, destfilename = null;
    boolean savelength = false;
    int length, offset;
    ...
    void loadfile(String sourcefilename) throws Exception {
        File file = new File(sourcefilename);
        if (length == 0) {
            length = (int) file.length();
        }
        if (length == 0) throw new Exception("Input file is empty!");
    ...
    int save(Pakdata p[], int q) throws Exception {
        s.init();
        int i, j;
    ...
    public int intMain(String args[]) throws Exception {
    ...
    public int sizeOfCompressedBuffer(List<Integer> bytes) throws Exception {
        offset = 0;
        length = bytes.size();
