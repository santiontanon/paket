...
public class PAKETCompiler {
    ...
    {        
        ...
        getPlayerObjectProperties(game, config);
        ...
        // Pathfinding buffer size checks:
        ...
        // Instantiate additional assembler files:
...
//        platform.generateItemData(platform.targetSystemName + "/src/", game.itemIDs, game.itemHash, game.textIDHash, destinationFolder, game);
    ...
    public static void getPlayerObjectProperties(PAKGame game, PAKETConfig config) throws Exception
    {
        boolean found = false;
        for(PAKRoom r:game.rooms) {
